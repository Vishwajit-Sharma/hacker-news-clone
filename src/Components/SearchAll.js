...
export default function SearchDefault(props) {
  ...
  useEffect(()=>{
    const fetchNews = async () =>{
      const url = props.secondFilter === "popularity" ? `http://hn.algolia.com/api/v1/search?query=${props.search}&page=${page}&hitsPerPage=50&numericFilters=${timeFilter}` : `http://hn.algolia.com/api/v1/search_by_date?query=${props.search}&page=${page}&hitsPerPage=50&numericFilters=${timeFilter}`
